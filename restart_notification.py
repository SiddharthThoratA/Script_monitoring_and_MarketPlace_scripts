...
sys.stdout = open(f"{log_dir}\\restart_notification_{run_date}.log", 'a')
sys.stderr = open(f"{log_dir}\\restart_notification_{run_date}.log", 'a')
...
email_start_subject = f"Alert! CBIINDIA Windows vm has been restarted for {run_date}"
email_start_body = f"""CBIINDIA Windows vm has been restarted for {run_date}"""
...
message=f"Alert! CBIINDIA Windows vm has been restarted for {run_date}"
